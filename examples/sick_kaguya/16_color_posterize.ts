...
import { getPixels, reducePalette, dither, noDither } from "../../mod.ts";
...
const newImg = noDither(pixels.pixels, palette);
...
Deno.writeFileSync(`${__dirname}/16_color_posterized_kaguya.png`, i.toBuffer("image/png"));